...
import { isWebView } from '../services/firebase';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
          ...
          {isInWebView && (
            <div className="mb-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-2xl flex items-start gap-3">
              ...
              <p className="text-sm text-blue-300">
                Google login not available in WebView. Please use email & password instead.
              </p>
            </div>
          )}
          ...
          {/* Divider & Google Sign In - Hidden in WebView */}
          {!isInWebView && (
            <>
